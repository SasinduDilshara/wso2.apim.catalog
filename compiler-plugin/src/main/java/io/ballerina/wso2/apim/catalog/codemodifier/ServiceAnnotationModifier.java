...
import static io.ballerina.wso2.apim.catalog.utils.CommonUtils.isServiceCatalogConfigAnnotation;
...
//            }
            ...
            NodeList<AnnotationNode> updatedAnnotations = updateAnnotations(metadataNode.annotations(), openAPIDef);
    ...
    private NodeList<AnnotationNode> updateAnnotations(NodeList<AnnotationNode> currentAnnotations,
        ...
        for (AnnotationNode annotation: currentAnnotations) {
            if (isServiceCatalogConfigAnnotation(annotation)) {
